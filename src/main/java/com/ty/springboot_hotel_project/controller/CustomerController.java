...
public class CustomerController {
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Successfully Found The Customer"),
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Successfully Found The Admins"),
